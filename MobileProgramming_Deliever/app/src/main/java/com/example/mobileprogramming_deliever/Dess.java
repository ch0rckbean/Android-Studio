...
public class Dess extends TabActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.dess);
        ...
        TabHost.TabSpec menu = tabhost.newTabSpec("Menu").setIndicator("메뉴");
        menu.setContent(R.id.Menu);
        tabhost.addTab(menu);

        TabHost.TabSpec review=tabhost.newTabSpec("Review").setIndicator("리뷰");
